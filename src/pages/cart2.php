                ...
                <div class="form-group row">
                    <div class="jumbotron row mx-auto my-4">
                        ...
                        <table class="table table-bordered table-responsive table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" aria-label="Small"
                                            aria-describedby="inputGroup-sizing-sm" name="quantity[1]">

                                    </td>
                                    <td>15.00€</td>

                                    <td> <input type="submit" class="form-control btn btn-outline-danger"
                                            aria-label="Small" aria-describedby="inputGroup-sizing-sm" value="Delete"
                                            name="delete_click"></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" aria-label="Small"
                                            aria-describedby="inputGroup-sizing-sm" name="quantity[2]">
                                    </td>
                                    <td>19.25€</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" aria-label="Small"
                                            aria-describedby="inputGroup-sizing-sm" name="quantity[3]">
                                    </td>
                                    <td>19.25€</td>
                        ...
                        <div class="submit-booking">
                            ...
                            <input type="submit" class="btn btn-primary submit" name="update_click"
                                value="Update"></input>
                            <a href="menu.php" class="btn btn-outline-success"><i
                    ...
                    <form id="cart-form" action="cart.php?action=submit">
                        <fieldset>
                            ...
                            <div class="submit-booking">
                                ...
                                <input type="submit" class="btn btn-primary submit" name="order_click"></input>
                            </div>
                        </fieldset>
                    </form>
                </div>
